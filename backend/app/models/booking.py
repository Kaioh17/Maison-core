...
class Bookings(Base):
    ...
    booking_status = Column(String,CheckConstraint("booking_status IN ('pending', 'completed', 'cancelled', 'delayed', 'confirmed')",name="booking_status_check_connstraint") ,nullable=False, default = 'pending', server_default=text("'pending'"))
